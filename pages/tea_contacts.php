...
<head>
    ...
    <link rel="stylesheet" href="../css/pages_tea_contacts/tea_contacts.css">
    <link rel="stylesheet" href="../css/pages_tea_contacts/tea_contacts_adaptive.css">
...
<div class="opacity_fon" id="js_of">
    <div class="left_menu">
        ...
        <div class="left_menu__content">
            ...
            <a href="#" class="left_menu__body active">Контакты</a>
        </div>
    </div>
</div>
    ...
    <div id="menu">
        ...
        <div id="menu-items">
            <div id="menu-items-container">
                ...
                <a href="#" class="menu-item active">Контакты</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div id="tea-contacts-container">
        ...
        <div class="content">
            <div class="contact_container">
                <div class="logo">
                    <?php include('../images/svg/location-icon.svg') ?>
                </div>
                <div class="section">
                    Адрес
                </div>
            ...
            <div class="contact_container">
                <div class="logo">
                    <?php include('../images/svg/call-icon.svg') ?>
                </div>
                <div class="section">
                    Телефон
                </div>
            ...
            <div class="contact_container">
                <div class="logo">
                    <?php include('../images/svg/telephone-icon.svg') ?>
                </div>
                <div class="section">
                    Факс
                </div>
            ...
            <div class="contact_container">
                <div class="logo">
                    <?php include('../images/svg/email-icon.svg') ?>
                </div>
                <div class="section">
                    Почта
                </div>
                <div class="text">
                    teaberry-ishop@gmail.com
                </div>
            </div>
        </div>
    </div>
...
<script src="../js/pages_tea_contacts/tea_contacts.js"></script>
</body>
</html>
